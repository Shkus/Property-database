namespace RehabilityApplication.CoreLib
{
	partial class MainForm
	{
		...
		private void InitializeComponent()
		{
			...
			btnSSSShkus = new DevExpress.XtraBars.BarButtonItem();
			...
			btnGenerateDocumentShkus = new DevExpress.XtraBars.BarButtonItem();
			...
			RC.Items.AddRange(new DevExpress.XtraBars.BarItem[] { RC.ExpandCollapseItem, RC.SearchEditItem, Skins, SkinPalettes, btnShowSplashScreen, btnGenerateDocuments, btnSSSShkus, btnGenerateDocumentShkus });
			...
			// btnSSSShkus
			// 
			btnSSSShkus.Caption = "ShowScreenSplash";
			btnSSSShkus.Id = 7;
			btnSSSShkus.ImageOptions.Image = (System.Drawing.Image)resources.GetObject("btnSSSShkus.ImageOptions.Image");
			btnSSSShkus.ImageOptions.LargeImage = (System.Drawing.Image)resources.GetObject("btnSSSShkus.ImageOptions.LargeImage");
			btnSSSShkus.Name = "btnSSSShkus";
			// 
			// pageDatabase
			// 
			...
			groupDatabase.ItemLinks.Add(btnSSSShkus);
			...
			groupDocumentHandles.ItemLinks.Add(btnGenerateDocumentShkus);
			...
			// 
			// btnGenerateDocumentShkus
			// 
			btnGenerateDocumentShkus.Caption = "Сгенерировать доки Шкус";
			btnGenerateDocumentShkus.Id = 8;
			btnGenerateDocumentShkus.ImageOptions.Image = (System.Drawing.Image)resources.GetObject("btnGenerateDocumentShkus.ImageOptions.Image");
			btnGenerateDocumentShkus.ImageOptions.LargeImage = (System.Drawing.Image)resources.GetObject("btnGenerateDocumentShkus.ImageOptions.LargeImage");
			btnGenerateDocumentShkus.Name = "btnGenerateDocumentShkus";
			// 
			// MainForm
			// 
		...
		private DevExpress.XtraBars.BarButtonItem btnSSSShkus;
		private DevExpress.XtraBars.BarButtonItem btnGenerateDocumentShkus;
	}
}