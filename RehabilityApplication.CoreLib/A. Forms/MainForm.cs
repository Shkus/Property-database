...
namespace RehabilityApplication.CoreLib
{
	...
	public partial class MainForm : DevExpress.XtraBars.Ribbon.RibbonForm
	{
		...
		public MainForm()
		{
			...
			btnSSSShkus.ItemClick += (s, e) =>
			{
				Task.Run(() =>
				{
					SplashScreenManager.ShowForm(this, typeof(waitForm), true, true, true, true);
					System.Threading.Thread.Sleep(5000);
					SplashScreenManager.CloseForm();
				});
			};

			btnGenerateDocumentShkus.ItemClick += (s, e) =>
			{
				Task.Run(() =>
				{
					SplashScreenManager.ShowForm(this, typeof(waitForm), true, true, true, true);
					DocGenManagerShkus.GenerateDocShkus();
					SplashScreenManager.CloseForm();
				});
